# Mapa de documentación operativa

## Guías principales

- [SDK de extensiones](extensions_sdk.md)
...
- [Guía de providers LLM](llm_providers.md)
- [Guía de integración MCP y broker HTTP](mcp_broker_integration.md)
- [Troubleshooting](troubleshooting.md)


## Refactor de `openclaw`

- [Cierre y artefactos de la fase de refactor](refactor/README.md)
